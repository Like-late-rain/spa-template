...
export interface YCTokenInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'getETHAmount', values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: 'getTokenAmount', values: [BigNumberish]): string;
  ...
  decodeFunctionResult(functionFragment: 'getETHAmount', data: BytesLike): Result;
...
export interface YCToken extends BaseContract {
  ...
  getETHAmount: TypedContractMethod<[tokenAmount: BigNumberish], [bigint], 'view'>;

  getTokenAmount: TypedContractMethod<[ethAmount: BigNumberish], [bigint], 'view'>;
  ...
  sellTokens: TypedContractMethod<[tokenAmount: BigNumberish], [void], 'nonpayable'>;
  ...
  getFunction(nameOrSignature: 'EXCHANGE_RATE'): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(nameOrSignature: 'INITIAL_SUPPLY'): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(
  ...
  getFunction(nameOrSignature: 'buyTokens'): TypedContractMethod<[], [void], 'payable'>;
